...
import { AppstoreOutlined, CaretRightOutlined, ClockCircleOutlined, MenuUnfoldOutlined, MenuFoldOutlined, LineChartOutlined, CheckOutlined, ArrowLeftOutlined } from '@ant-design/icons';
...
const Block = () => {
  ...
  useRunOnce(() => {
    ...
    if (targetBlock) {
      ...
      // 没有目标板块，设置默认选中的板块
      const initialSelected = ['银行', 'cpo', '半导体', '消费', '光模块', '存储'];
