...
import { DollarOutlined, DesktopOutlined, AppstoreOutlined, MenuFoldOutlined, MenuUnfoldOutlined, BookOutlined, CoffeeOutlined, ThunderboltOutlined, AreaChartOutlined, FileTextOutlined, CalendarOutlined, BarChartOutlined, GlobalOutlined } from '@ant-design/icons';
...
function App() {
  ...
  return (
    <Layout className="app-layout">
      ...
      <Modal
        title={<span><GlobalOutlined style={{ color: '#1890ff', marginRight: '8px' }} />全局分析</span>}
